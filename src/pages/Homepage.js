            ...
            >
              <motion.div className="step-item" variants={fadeIn}>
                ...
                <div className="step-content">
                  ...
                  <p>Message us via Messenger or email your .STL/.3MF file. We'll analyze your model and provide a detailed quote within 24 hours.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="step-item" variants={fadeIn}>
                ...
                <div className="step-content">
                  ...
                  <p>Choose your preferred filament type and color from our available options. We'll guide you to the best material for your specific application.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="step-item" variants={fadeIn}>
                ...
                <div className="step-content">
                  <h3>Payment</h3>
                  <p>Pay securely via GCash or bank transfer. Once payment is confirmed, we immediately start the printing process for your order.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="step-item" variants={fadeIn}>
                ...
                <div className="step-content">
                  <h3>Delivery</h3>
                  <p>Your print is carefully quality-checked, packaged securely, and shipped via reliable courier services with tracking information provided.</p>
                </div>
              </motion.div>
            </motion.div>
          </div>
